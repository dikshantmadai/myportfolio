...
const Data = () => {
    return (
        <div className="home__data">
            ...
            <h3 className="home__subtitle">Data Analysist</h3>
            <p className="home__description">I'm a creative data analyst based in 
            Kathmandu, and I am highly passionate and dedicated to my work. 
            My goal for the future is to transition into the role of a 
            data scientist </p>
