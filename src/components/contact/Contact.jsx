...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm(
                'service_ihlejkm', // Replace with your EmailJS service ID
                'template_sxwrstn', // Replace with your EmailJS template ID
                form.current,
                '-5IdiPwb-p5LnJqF5' // Replace with your EmailJS user ID
            )
            e.target.reset()
            .then(
                (result) => {
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+977 9862480622</span>
                            <a href="tel:+9779862480622" className="contact__button">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">@dikshantMadai</span>
                            <a
                                href="https://www.linkedin.com/in/dikshantMadai"
                                className="contact__button"
                            >
